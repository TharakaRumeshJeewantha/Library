...
<?php
	...
	$query = "INSERT INTO tbl_books_damages (bk_no, reason, comment) VALUES ('{$bk_no}','{$reason}','{$comment}')";
	$qry = "UPDATE tbl_books SET bk_damages = bk_damages+1, bk_available = bk_available-1 WHERE bk_no = '$bk_no'";

	$result = mysqli_query($db, $query);
	$rslts = mysqli_query($db, $qry);
...
<!-- 									<li>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Remove Dismiss or Damages Books from Stock</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Remove Books</span></li>
								<li><span>Dismiss or Damage Books</span></li>
							</ol>
				...
				<div class="col-xs-12">
								...
								<section class="panel form-wizard" id="w1">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Dismiss or Damage Books Details</h2>
									</header>
									<div class="panel-body panel-body-nopadding">
											...
											<ul class="wizard-steps">
												<li class="active">
													<a href="#w1-account" data-toggle="tab" class="text-center">
														...
														Remove Dismiss or Damage Books from Stock
													</a>
												</li>
											</ul>
										</div>
										<br>
										<br>
										<form class="form-horizontal" action="punishments.php" method="POST" novalidate="novalidate">
											...
											<div class="form-group">
													...
													<div class="form-group">
													<label class="col-sm-4 control-label" for="profileAddress">Comments</label>
													<div class="col-md-4 control-label">
														<div class="input-group">
															<span class="input-group-addon">
																<i class="fa fa-comment"></i>
															</span>
														<textarea class="form-control input-sm" type="text" name="comment" rows="3" id="comment"  data-plugin-maxlength maxlength="140" required></textarea>
													</div>
												</div>
												</div>
...
<?php
	if (isset($errors) && !empty($errors)) {
		echo '<div class="alert alert-success" style="text-align:center;"><strong>Success! </strong> Book Removed Successfully </div>';
	}
?>
