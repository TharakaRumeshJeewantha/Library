...
<?php
	...
	$query = "SELECT *  FROM tbl_transactions t, tbl_books b, tbl_students s WHERE s.std_reg_no = t.std_no AND b.bk_no = t.bk_no";
	$books_issued = mysqli_query($db, $query);

	if ($books_issued) {
		while ($book_issued = mysqli_fetch_assoc($books_issued)) {
			
			// ////////////////////////////////////////////
			$issued_list .= "<div class='isotope-item {$book_issued['bk_category_no']} col-sm-6 col-md-4 col-lg-3'>";
			$issued_list .=	"<div class='thumbnail'>";
			$issued_list .=	"<div class='thumb-preview'>";
			$issued_list .=	"<a class='thumb-image' href='assets/images/projects/temp.jpg'>";
			$issued_list .=	"<img src='assets/images/projects/temp.jpg' class='img-responsive' alt='Project'>";
			$issued_list .=	"</a>";
			$issued_list .=	"<div class='mg-thumb-options'>";
			$issued_list .=	"<div class='mg-zoom'><i class='fa fa-search'></i></div>";
			$issued_list .=	"<div class='mg-toolbar'>";
			$issued_list .=	"<div class='mg-option checkbox-custom checkbox-inline'>";
			$issued_list .=	"<input type='checkbox' id='file_1' value='1'>";
			$issued_list .=	"<label for='file_1'>SELECT</label>";
			$issued_list .=	"</div>";
			$issued_list .=	"<div class='mg-group pull-right'>";
			$issued_list .=	"<a href='#'>EDIT</a>";
			$issued_list .=	"<button class='dropdown-toggle mg-toggle' type='button' data-toggle='dropdown'>";
			$issued_list .=	"<i class='fa fa-caret-up'></i>";
			$issued_list .=	"</button>";
			$issued_list .=	"<ul class='dropdown-menu mg-menu' role='menu'>";
			$issued_list .=	"<li><a href='#'><i class='fa fa-download'></i> Download</a></li>";
			$issued_list .=	"<li><a href='#'><i class='fa fa-trash-o'></i> Delete</a></li>";
			$issued_list .=	"</ul>";
			$issued_list .=	"</div>";
			$issued_list .=	"</div>";
			$issued_list .=	"</div>";
			$issued_list .=	"</div>";
			$issued_list .=	"<h5 class='mg-title text-semibold'>{$book_issued['bk_name']}<small> edition : {$book_issued['bk_edition']}</small></h5>";
			$issued_list .=	"<div class='mg-description'>";
			$issued_list .=	"<small class='pull-left text-muted'>{$book_issued['std_fname']} {$book_issued['std_lname']}</small>";
			$issued_list .=	"<small class='pull-right text-muted'>{$book_issued['std_no']}</small><br>";
			$issued_list .=	"<small class='pull-left text-muted'>{$book_issued['bk_category_no']}</small>";
			$issued_list .=	"<small class='pull-right text-muted'>{$book_issued['bk_no']}</small><br>";
			$issued_list .=	"<small class='pull-left text-muted'>{$book_issued['teacher']}</small>";
			$issued_list .=	"<small class='pull-right text-muted'>{$book_issued['std_grade']} - {$book_issued['std_class']}</small><br>";
			$issued_list .=	"<small class='pull-left text-muted'>Issued : {$book_issued['bk_issued_date']}</small>";
			$issued_list .=	"<small class='pull-right text-muted'>Return : {$book_issued['bk_should_return_date']}</small>";
			$issued_list .=	"</div>";
			$issued_list .=	"</div>";
			$issued_list .=	"</div>";
			// ////////////////////////////////////////////
...
<!-- 									<li>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>View All Books Issue Details</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>All Issue Details</span></li>
							</ol>
