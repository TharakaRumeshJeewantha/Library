...
<?php
	...
	$bk_category_no = mysqli_real_escape_string($db, $_POST['bk_category_no']);
	$bk_name = mysqli_real_escape_string($db, $_POST['bk_name']);
	$bk_edition = mysqli_real_escape_string($db, $_POST['bk_edition']);
	$bk_author = mysqli_real_escape_string($db, $_POST['bk_author']);
	$bk_publisher = mysqli_real_escape_string($db, $_POST['bk_publisher']);
	$year = mysqli_real_escape_string($db, $_POST['year']);
	$page = mysqli_real_escape_string($db, $_POST['page']);
	// $bk_grade = mysqli_real_escape_string($db, $_POST['bk_grade']);
	$bk_cost = mysqli_real_escape_string($db, $_POST['bk_cost']);
	$bk_qty = mysqli_real_escape_string($db, $_POST['bk_qty']);


	$chk_bid = "SELECT bk_no FROM tbl_books WHERE bk_no='".$bk_no."'";
	$res    = mysqli_query($db, $chk_bid);
    $count_bk  = mysqli_num_rows($res);

    if($count_bk > 0) {
    	$errors1 = "Book No Already Exists. Try again with different Book No";
    }

    else {

	$query = "INSERT INTO tbl_books (bk_no, bk_category_no, bk_name, bk_edition, bk_author, bk_publisher, bk_cost, bk_qty, bk_available, year, page) VALUES ('{$bk_no}','{$bk_category_no}','{$bk_name}','{$bk_edition}','{$bk_author}','{$bk_publisher}', '{$bk_cost}', '{$bk_qty}', '{$bk_qty}', '{$year}', '{$page}')";

	$result = mysqli_query($db, $query);

	if($result) {
		$errors[] = 'Book Added Successfully';
	}
	else {
		$errors[] = 'Book Added Failed';
	}
	}
	}
?>
							...
							<div class="col-lg-12">
								<section class="panel">
									...
									<div class="panel-body">
										<form class="form-horizontal" action="new_books.php" method="POST">
												<br>
												<br>
													...
													<div class="form-group">
														...
														<div class="input-group">
															...
															<input type="number" class="form-control input-sm" minlength="1" maxlength="3" name="bk_no" id="w1-bno" required>
														</div>
													</div>
<?php
	if (isset($errors1) && !empty($errors1)) {
		echo '<div class="alert alert-danger" style="text-align:center;"><strong>Warning! </strong> Book No Already Exists. Try again with different Book No </div>';
	}
?>	
													</div>
													...
													<div class="form-group">
														<label class="col-sm-4 control-label" for="w1-bname">Book Name</label>
														<div class="col-md-4 control-label">
														<div class="input-group">
															<span class="input-group-addon">
																<i class="fa fa-book"></i>
															</span>
															<input type="text" class="form-control input-sm" name="bk_name" id="w1-bname" required>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group">
														<label class="col-sm-4 control-label">Edition No / Book Category</label>
														...
														<div class="input-group">
															...
															<select id="edition" name="bk_edition" class="form-control input-sm" required>
																<option value="">Choose a Edition</option>
											...
											<div class="form-group">
														<label class="col-sm-4 control-label" for="w1-cost">Book Author</label>
														<div class="col-md-4 control-label">
														<div class="input-group">
															<span class="input-group-addon">
																<i class="fa fa-user"></i>
															</span>
															<input type="text" class="form-control input-sm" name="bk_author" id="w1-cost" required>
														</div>
													</div>
													</div>
											...
											<div class="form-group">
														<label class="col-sm-4 control-label" for="w1-cost">Book Publisher</label>
														<div class="col-md-4 control-label">
														<div class="input-group">
															<span class="input-group-addon">
																<i class="fa fa-truck"></i>
															</span>
															<input type="text" class="form-control input-sm" name="bk_publisher" id="w1-cost" required>
														</div>
													</div>
													</div>
													...
													<div class="row">
													<div class="form-group">
														<label class="col-sm-4 control-label" for="w1-year">Published Year / Pages</label>
														<div class="col-md-2 control-label">
														<div class="input-group">
															<span class="input-group-addon">
																<i class="fa fa-calendar-o"></i>
															</span>
															<input type="number" class="form-control input-sm" name="year" placeholder="year" minlength="4" maxlength="4" max="2019" min="2000" id="w1-year">
													...
													<!-- <div class="form-group"> -->
														...
														<!-- <label class="col-sm-4 control-label" for="w1-page">No of Pages</label> -->
														<div class="col-md-2 control-label">
														<div class="input-group">
															<span class="input-group-addon">
																<i class="fa fa-book"></i>
															</span>
															<input type="number" class="form-control input-sm" minlength="1" placeholder="pages" maxlength="3" name="page" id="w1-page" required>
														</div>
													</div>
													</div>
													</div>
...
<!-- 
													<div class="form-group">
														<label class="col-sm-4 control-label">Suitable Grade</label>
														<div class="col-sm-6">
															<select id="grade" name="bk_grade" class="form-control" required>
													...
													<!-- <div class="form-group">
														<label class="col-sm-4 control-label" for="w1-cost">Book Cost</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm" name="bk_cost" id="w1-cost" required>
														</div>
													</div> -->
													...
													<div class="form-group">
														<label class="col-sm-4 control-label" for="w1-cost">Book Cost / Quantity</label>
														<div class="col-md-2">
														<div class="input-group">
														<input type="number" name="bk_cost" placeholder="cost" class="form-control input-sm" required>
													...
													<!-- <div class="form-group"> -->
														...
														<div class="input-group">
															...
															<input type="number" class="form-control input-sm" minlength="1" maxlength="3" placeholder="quantity" name="bk_qty" id="w1-qty" required>
														</div>
													</div>
												</div>
													<!-- </div> -->
...
<?php
	if (isset($errors) && !empty($errors)) {
		echo '<div class="alert alert-success" style="text-align:center;"><strong>Success! </strong> Book Added Successfully </div>';
	}
?>		
