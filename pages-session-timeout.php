...
<html class="fixed">
	<head>
		...
		<title>Session Timeout | Okler Themes | Porto-Admin</title>
								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent nav-expanded nav-active">
										...
										<ul class="nav nav-children">
											...
											<li>
												<a href="pages-recover-password.php">
													 Recover Password
												</a>
											</li>
											<li>
												<a href="pages-lock-screen.php">
													 Locked Screen
												</a>
											</li>
											<li>
											...
											<li class="nav-active">
												<a href="pages-session-timeout.php">
													 Session Timeout
												</a>
											</li>
											<li>
											...
											<li>
												<a href="pages-media-gallery.php">
													 Media Gallery
												</a>
											</li>
											<li>
											...
											<li>
												<a href="pages-500.php">
													 500
												</a>
											</li>
											<li>
												<a href="pages-log-viewer.php">
													 Log Viewer
												</a>
											</li>
											<li>
												<a href="pages-search-results.php">
													 Search Results
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="ui-elements-typography.php">
													 Typography
												</a>
											</li>
											<li>
												<a href="ui-elements-icons.php">
													 Icons
												</a>
											</li>
											<li>
												<a href="ui-elements-tabs.php">
													 Tabs
												</a>
											</li>
											<li>
												<a href="ui-elements-panels.php">
													 Panels
												</a>
											</li>
											<li>
												<a href="ui-elements-widgets.php">
													 Widgets
												</a>
											</li>
											<li>
												<a href="ui-elements-portlets.php">
													 Portlets
												</a>
											</li>
											<li>
												<a href="ui-elements-buttons.php">
													 Buttons
												</a>
											</li>
											<li>
												<a href="ui-elements-alerts.php">
													 Alerts
												</a>
											</li>
											<li>
												<a href="ui-elements-notifications.php">
													 Notifications
												</a>
											</li>
											<li>
												<a href="ui-elements-modals.php">
													 Modals
												</a>
											</li>
											<li>
												<a href="ui-elements-lightbox.php">
													 Lightbox
												</a>
											</li>
											<li>
												<a href="ui-elements-progressbars.php">
													 Progress Bars
												</a>
											</li>
											<li>
												<a href="ui-elements-sliders.php">
													 Sliders
												</a>
											</li>
											<li>
												<a href="ui-elements-carousels.php">
													 Carousels
												</a>
											</li>
											<li>
												<a href="ui-elements-accordions.php">
													 Accordions
												</a>
											</li>
											<li>
												<a href="ui-elements-nestable.php">
													 Nestable
												</a>
											</li>
											<li>
												<a href="ui-elements-tree-view.php">
													 Tree View
												</a>
											</li>
											<li>
												<a href="ui-elements-grid-system.php">
													 Grid System
												</a>
											</li>
											<li>
												<a href="ui-elements-charts.php">
													 Charts
												</a>
											</li>
											<li>
												<a href="ui-elements-animations.php">
													 Animations
												</a>
											</li>
											<li>
												<a href="ui-elements-extra.php">
													 Extra
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li>
												<a href="tables-editable.php">
													 Editable
												</a>
											</li>
											<li>
												<a href="tables-ajax.php">
													 Ajax
												</a>
											</li>
											<li>
												<a href="tables-pricing.php">
													 Pricing
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="maps-google-maps.php">
													 Basic
												</a>
											</li>
											<li>
												<a href="maps-google-maps-builder.php">
													 Map Builder
												</a>
											</li>
											<li>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li>
												<a href="layouts-menu-collapsed.php">
													 Menu Collapsed
												</a>
											</li>
											<li>
												<a href="layouts-scroll.php">
													 Scroll
												</a>
											</li>
										</ul>
