...
<?php
	...
	// $query1 = "SELECT *  FROM tbl_transactions t, tbl_books b, tbl_students s WHERE s.std_reg_no = t.std_no AND b.bk_no = t.bk_no";
...
$errors = array();
	...
	$returned = mysqli_real_escape_string($db, $_POST['returned']);
	$tid = mysqli_real_escape_string($db, $_POST['tid']);
	$bk_no = mysqli_real_escape_string($db, $_POST['bk_no']);

	$query1 = "UPDATE tbl_transactions SET bk_returned_date='{$returned}',t_status='done' WHERE tid = $tid";

	$result1 = mysqli_query($db, $query1);

	//  $qry1 = "SELECT bk_no FROM tbl_transactions WHERE tid = $tid";
	//  $rslt1 = mysqli_query($db, $qry1);
	//  $bk_no_1 = mysqli_fetch_assoc($rslt1);

	// $qry2 = "SELECT bk_available FROM tbl_books WHERE bk_no = $bk_no_1";
	// $rslt2 = mysqli_query($db, $qry2);
	// $bk_no_2 = mysqli_fetch_assoc($rslt2);

	$qry3 = "UPDATE tbl_books SET bk_available = bk_available+1 WHERE bk_no = $bk_no";
	$rslt3 = mysqli_query($db, $qry3);
...
$(document).ready(function() {
   ...
   $("#search").keyup(function() {
       ...
       //If name is not empty.
		...
		<!-- <script>
            $(document).ready(function(){
            $('#std_reg_no').change(function(){
                //Selected value
                var inputValue = $(this).val();
                alert("value in js "+inputValue);

                //Ajax for calling php function
                $.post('ajax_return.php', { dropdownValue: inputValue }, function(data){
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<section class="panel form-wizard" id="w1">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Returning Book</h2>
									</header>
									<div class="panel-body panel-body-nopadding">
										...
										<br>
										<br>
										<form class="form-horizontal" action="return_books.php" method="POST" novalidate="novalidate">
											...
											<!-- <div class="form-group">
												...
												<div class="col-md-6">
													<select id="search" data-plugin-selectTwo class="form-control populate" name="std_reg_no" data-plugin-options='{ "minimumInputLength": 1 }'>
											...
											<div class="form-group">
												<label class="col-sm-8 control-label" for="issuedDate">Student Enrollment (Reg No)</label>
												<div class="col-md-2">
													<input class="form-control input-sm"  name="std_no" id="search" type="text" placeholder="Registration No">
												</div>
											</div>

											<br>

											<div id="div_bk_no"></div>
							...
							<!-- 		<a class="modal-with-form btn btn-default" href="#modalForm">Open Form</a>
									...
									<!-- <div id="modalForm" class="modal-block modal-block-primary mfp-hide">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Punishment Cost Calculation</h2>
											</header>
											<div class="panel-body">
												<br>
												<form id="demo-form" class="form-horizontal mb-lg" novalidate="novalidate">
													<div class="form-group">
														<label class="col-sm-3 control-label">Days of Late</label>
														<div class="col-sm-9">
															<input type="text" name="email" class="form-control" placeholder="number of days" required/>
														</div>
													</div>
													<br>
													<div class="form-group">
...
<?php
	if (isset($errors) && !empty($errors)) {
		echo '<div class="alert alert-success" style="text-align:center;"><strong>Success! </strong> Book Returned Successfully </div>';
	}
?>
