...
<?php
	...
	$query = "SELECT * FROM tbl_students ORDER BY std_fname, std_lname";
	...
	if ($students) {
		while ($student = mysqli_fetch_assoc($students)) {
			...
			// ////////////////////////////////////////////
			$students_list .= 	"<div class='isotope-item {$student['std_grade']} col-sm-6 col-md-4 col-lg-3'>";
			...
			$students_list .=	"<img src='assets/images/projects/boy.jpg' class='img-responsive' alt='Project'>";
			$students_list .=	"</a>";
			...
			$students_list .=	"<img src='assets/images/projects/girl.jpg' class='img-responsive' alt='Project'>";
			$students_list .=	"</a>";
			...
			$students_list .=	"</div>";
			$students_list .=	"</div>";
			$students_list .=	"<h5 class='mg-title text-semibold'>{$student['std_fname']} {$student['std_lname']}<small> gender : {$student['std_gender']}</small></h5>";
			$students_list .=	"<div class='mg-description'>";
			$students_list .=	"<small class='pull-left text-muted'>Enrollment No : {$student['std_reg_no']}</small>";
			$students_list .=	"<small class='pull-right text-muted'>Books Read : {$student['std_read']}</small><br>";
			$students_list .=	"<small class='pull-left text-muted'>Teacher : {$student['teacher']}</small>";
			$students_list .=	"<small class='pull-right text-muted'>Grade : {$student['std_grade']} - {$student['std_class']}</small>";
			$students_list .=	"</div>";
			$students_list .=	"</div>";
			$students_list .=	"</div>";
			// ////////////////////////////////////////////
			...
			<div class="progress">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>View All Students Details</h2>
