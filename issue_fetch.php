        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<h5><center>Are you sure? you want to delete 'TID<strong><?php echo $drow['tid']; ?>' </strong>  Transaction?</center></h5> 
                </div> 
				</div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                    <a href="issue_delete.php?id=<?php echo $issuing['tid']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
    ...
    <div class="modal fade" id="edit<?php echo $issuing['tid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <center><h4 class="modal-title" id="myModalLabel">Modify Issuing Details</h4></center>
                </div>
                <div class="modal-body">
				<?php
				...
				?>
				<div class="container-fluid">
				<form method="POST" action="issue_edit.php?id=<?php echo $erow['tid']; ?>">
