...
<?php
	...
	if ($issuings) {
		while ($issuing = mysqli_fetch_assoc($issuings)) {
			...
			$issue_lists .=	"<td>{$issuing['std_reg_no']} . {$issuing['std_fname']} {$issuing['std_lname']} ({$issuing['std_grade']} - {$issuing['std_class']})</td>";
		 	$issue_lists .=	"<td>{$issuing['bk_no']} ({$issuing['bk_category_no']}) . {$issuing['bk_name']} ({$issuing['bk_edition']}) </td>";
			...
			<div class="progress">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Edit / Delete Issues Details</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Update Issue Details</span></li>
							</ol>
					...
					<!-- start: page -->
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Update Lending Details</h2>
							</header>
