...
<html class="fixed sidebar-left-collapsed">
	<head>
		...
		<title>Compose | Okler Themes | Porto-Admin</title>
						...
						<div class="nano-content">
							...
							<div class="sidebar-widget widget-stats">
								<div class="widget-header">
									<h6 style="color: white;">Company Stats</h6>
								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											<a href="mailbox-compose.php" class="btn btn-block btn-primary btn-md pt-sm pb-sm text-md">
											...
											<ul class="list-unstyled mt-xl pt-md">
												<li>
													<a href="mailbox-folder.php" class="menu-item active">Inbox <span class="label label-primary text-normal pull-right">43</span></a>
												</li>
												<li>
													<a href="mailbox-folder.php" class="menu-item">Important</a>
												</li>
												<li>
													<a href="mailbox-folder.php" class="menu-item">Sent</a>
												</li>
												<li>
													<a href="mailbox-folder.php" class="menu-item">Drafts</a>
												</li>
												<li>
													<a href="mailbox-folder.php" class="menu-item">Trash</a>
												</li>
											</ul>
