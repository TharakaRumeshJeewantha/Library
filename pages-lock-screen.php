			...
			<div class="center-sign">
				<div class="panel panel-sign">
					<div class="panel-body">
						<form action="pages-lock-screen.php" method="POST">
...
<?php
	if (isset($errors) && !empty($errors)) {
		echo '<div class="alert alert-danger" style="text-align:center;"><strong>Warning! </strong> Invalid Password. Try again </div>';
	}
?>
