...
<?php
	...
	$query = "SELECT * FROM tbl_teachers ORDER BY t_fname, t_lname";
	...
	if ($students) {
		while ($student = mysqli_fetch_assoc($students)) {
			...
			// ////////////////////////////////////////////
			$students_list .= 	"<div class='isotope-item {$student['t_grade']} col-sm-6 col-md-4 col-lg-3'>";
			$students_list .=	"<div class='thumbnail'>";
			$students_list .=	"<div class='thumb-preview'>";

			if ($student['t_gender'] == 'Male') {

			$students_list .=	"<a class='thumb-image' href='assets/images/projects/boy.jpg'>";
			$students_list .=	"<img src='assets/images/projects/sir.jpg' class='img-responsive' alt='Project'>";
			$students_list .=	"</a>";


			} else {

			$students_list .=	"<a class='thumb-image' href='assets/images/projects/girl.jpg'>";
			$students_list .=	"<img src='assets/images/projects/teacher.jpg' class='img-responsive' alt='Project'>";
			$students_list .=	"</a>";

			}

			$students_list .=	"<div class='mg-thumb-options'>";
			$students_list .=	"<div class='mg-zoom'><i class='fa fa-search'></i></div>";
			$students_list .=	"<div class='mg-toolbar'>";
			$students_list .=	"<div class='mg-option checkbox-custom checkbox-inline'>";
			$students_list .=	"<input type='checkbox' id='file_1' value='1'>";
			$students_list .=	"<label for='file_1'>SELECT</label>";
			$students_list .=	"</div>";
			$students_list .=	"<div class='mg-group pull-right'>";
			$students_list .=	"<a href='#'>EDIT</a>";
			$students_list .=	"<button class='dropdown-toggle mg-toggle' type='button' data-toggle='dropdown'>";
			$students_list .=	"<i class='fa fa-caret-up'></i>";
			$students_list .=	"</button>";
			$students_list .=	"<ul class='dropdown-menu mg-menu' role='menu'>";
			$students_list .=	"<li><a href='#'><i class='fa fa-download'></i> Download</a></li>";
			$students_list .=	"<li><a href='#'><i class='fa fa-trash-o'></i> Delete</a></li>";
			$students_list .=	"</ul>";
			$students_list .=	"</div>";
			$students_list .=	"</div>";
			$students_list .=	"</div>";
			$students_list .=	"</div>";
			$students_list .=	"<h5 class='mg-title text-semibold'>{$student['t_fname']} {$student['t_lname']}<small> gender : {$student['t_gender']}</small></h5>";
			$students_list .=	"<div class='mg-description'>";
			$students_list .=	"<small class='pull-left text-muted'>NIC : {$student['t_nic']}</small>";
			$students_list .=	"<small class='pull-right text-muted'>Students : {$student['t_students']}</small><br>";
			$students_list .=	"<small class='pull-left text-muted'>Library slot : {$student['day_time']}</small>";
			$students_list .=	"<small class='pull-right text-muted'>Grade : {$student['t_grade']} - {$student['t_class']}</small>";
			$students_list .=	"</div>";
			$students_list .=	"</div>";
			$students_list .=	"</div>";
			// ////////////////////////////////////////////
			...
			<div class="progress">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>View All Teachers and Classes Details</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>View All Teachers</span></li>
							</ol>
									...
									<ul>
										...
										<li class="right" data-sort-source data-sort-id="media-gallery">
											<ul class="nav nav-pills nav-pills-primary">
												...
												<li>
													<a data-option-value=".1" href="#document">Grade 1</a>
												</li>
												<li>
													<a data-option-value=".2" href="#image">Grade 2</a>
												</li>
												<li>
													<a data-option-value=".3" href="#video">Grade 3</a>
												</li>
												<li>
													<a data-option-value=".4" href="#video">Grade 4</a>
												</li>
												<li>
													<a data-option-value=".5" href="#video">Grade 5</a>
												</li>
											</ul>
										</li>
									</ul>
