...
<?php
	...
	$query = "SELECT * FROM tbl_books b, tbl_books_damages d WHERE b.bk_no = d.bk_no";
	...
	if ($books) {
		while ($book = mysqli_fetch_assoc($books)) {
			...
			$books_list .=	"<small class='pull-left text-muted'>Reason : {$book['reason']}</small>";
			$books_list .=	"<small class='pull-right text-muted'>Available : {$book['bk_available']}</small><br>";
			$books_list .=	"<small class='pull-left text-muted'>{$book['comment']}</small>";
			$books_list .=	"</div>";
			$books_list .=	"</div>";
			$books_list .=	"</div>";
			// ////////////////////////////////////////////
			...
			<div class="progress">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>View All Dismiss or Damages Books Details</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>View Remove Books</span></li>
							</ol>
