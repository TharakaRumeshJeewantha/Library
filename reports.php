							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Reports Generator</h2>
									</header>
										...
										<form class="form-horizontal form-bordered" method="get">
												...
												<br>
													...
													<div class="form-group">
														<label class="col-sm-6 control-label">Report Category</label>
														<div class="col-md-3 control-label">
														<div class="input-group">
															<span class="input-group-addon">
																<i class="fa fa-flag"></i>
															</span>
															<select id="report" name="report" class="form-control input-sm" required>
																<option value="">Choose a Category</option>
																<option value="b">Books Report</option>
																<option value="s">Students Report</option>
																<option value="te">Teachers Report</option>
																<option value="o">Remove Book Report</option>
																<option value="trc">Completed Transactions Report</option>
																<option value="tre">Expired Transactions Report</option>
																<option value="trcu">Custom Transactions Report</option>
															</select>
