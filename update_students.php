...
<?php
	...
	if ($students) {
		while ($student = mysqli_fetch_assoc($students)) {
			...
			$students_list .=	"<tr style='font-size: 13px;'>";
			$students_list .=	"<td>{$student['std_reg_no']}</td>";
		 	$students_list .=	"<td>{$student['std_fname']} {$student['std_lname']}</td>";
			$students_list .=	"<td>{$student['std_grade']} - {$student['std_class']}</td>";
			$students_list .=	"<td class='actions'>";
			// $students_list .=	"<a href='#' class='hidden on-editing save-row'><i class='fa fa-save'></i></a>";
			// $students_list .=	"<a href='#' class='hidden on-editing cancel-row'><i class='fa fa-times'></i></a>";
			$students_list .=	"<a href='#edit{$student['sid']}' data-toggle='modal' ><i class='fa fa-pencil'></i></a>";
			$students_list .=	"<a href='#del{$student['sid']}' data-toggle='modal' ><i class='fa fa-trash-o'></i></a>";

			include('student_fetch.php');
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>(Edit / Delete Student)</span></li>
							</ol>
					...
					<!-- start: page -->
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Update Student's Details</h2>
							</header>
