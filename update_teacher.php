...
<?php
	...
	if ($teachers) {
		while ($teacher = mysqli_fetch_assoc($teachers)) {
			...
			$teachers_list .=	"<tr style='font-size: 13px;'>";
			$teachers_list .=	"<td name='aa'>{$teacher['t_fname']} {$teacher['t_lname']} ({$teacher['t_nic']})</td>";
			$teachers_list .=	"<td>{$teacher['t_grade']} - {$teacher['t_class']} (Students : {$teacher['t_students']})</td>";
			$teachers_list .=	"<td>{$teacher['day_time']}</td>";
			$teachers_list .=	"<td class='actions'>";
			// $teachers_list .=	"<a href='#' class='hidden on-editing save-row'><i class='fa fa-save'></i></a>";
			// $teachers_list .=	"<a href='#' class='hidden on-editing cancel-row'><i class='fa fa-times'></i></a>";
			$teachers_list .=	"<a href='#edit{$teacher['t_id']}' data-toggle='modal' ><i class='fa fa-pencil'></i></a>";
			$teachers_list .=	"<a href='#del{$teacher['t_id']}' data-toggle='modal' ><i class='fa fa-trash-o'></i></a>";
			
			include('teacher_fetch.php');
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>(Edit / Delete Teacher)</span></li>
							</ol>
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Update Teacher's Details</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									<thead>
										<tr style="font-size: 13px;">
											<th>Full Name & NIC</th>
											<th>Grade & Class with Students</th>
											<th>Library Day & Timeslot</th>
											<th>Actions</th>
										</tr>
									</thead>
									<tbody>

										<?php echo $teachers_list; ?>
